...
public class Obras {
    ...
    @JsonIgnoreProperties({"obras", "hibernateLazyInitializer"})
    private Categorias categoria;

    public Obras() {}

    public Obras(int id_obra, String titulo, String descripcion, float precio, int stock,
                 String image_url, Date fechaCreacion, Categorias categoria) {
